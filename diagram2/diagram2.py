...
with Diagram("VPC Architecture", show=True, graph_attr=graph_attr, outformat="png"):
    ...
    transit_gateway - Edge(color="brown", style="dashed") - vpc_prod_1
    transit_gateway - Edge(color="brown", style="dashed") - vpc_prod_2
    transit_gateway - Edge(color="brown", style="dashed") - vpc_data_integration
